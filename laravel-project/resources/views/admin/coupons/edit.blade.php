                    ...
                    <form action="{{ route('admin.coupons.update', $coupon->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="name" value="{{old('name',$coupon->name)}}" aria-describedby="helpId"
                                placeholder="Name*" />
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('discount') is-invalid @enderror"
                                name="discount" id="discount" value="{{old('discount',$coupon->discount)}}"
                                aria-describedby="helpId" placeholder="Discount*" />
                            @error('discount')
                            <span class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" value="{{$coupon->valid_until}}"
