                    ...
                    <form action="{{route('admin.products.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('qty') is-invalid @enderror" name="qty"
                                id="qty" value="{{old('qty')}}" aria-describedby="helpId" placeholder="Quantity*" />
                            @error('qty')
                            <span class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" name="price"
                                id="price" value="{{old('price')}}" aria-describedby="helpId" placeholder="Price*" />
                            @error('price')
                            <span class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('color_id') is-invalid @enderror" name="color_id[]"
                                ...
                                <option value="{{$color->id}}" @if(collect(old('color_id'))->contains($color->id))
                                    selected @endif>
                                    {{ $color->name }}
                                </option>
                                @endforeach
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('size_id') is-invalid @enderror" name="size_id[]"
                                ...
                                <option value="{{$size->id}}" @if(collect(old('size_id'))->contains($size->id)) selected
                                    @endif>
                                    {{ $size->name }}
                                </option>
                                @endforeach
                        ...
                        <div class="mt-2">
                            <img src="#" alt="" id="thumbnail_preview" class="d-none img-fluid rounded mb-2"
                        ...
                        <div class="mt-2">
                            <img src="#" alt="" id="first_image_preview" class="d-none img-fluid rounded mb-2"
                                height="100" width="100">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img src="#" alt="" id="second_image_preview" class="d-none img-fluid rounded mb-2"
                                height="100" width="100">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img src="#" alt="" id="third_image_preview" class="d-none img-fluid rounded mb-2"
                                height="100" width="100">
                        </div>
